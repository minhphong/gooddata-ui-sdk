    ...
    describe(
        ...
        () => {
            ...
            it.skip("Drilling down continue on a table ", () => {
                ...
                drillModal.hasTitleHeader(
                    "table has row column measure › " + DIRECT_SALES + " › Educationly",
                );
            ...
            it.skip("Drilling down on chart that have two attribute same bucket with two drillable attributes", () => {
                ...
                drillModal
                    .hasTitleHeader(
                        "bullet with two attributes same bucket › " + DIRECT_SALES + " › CompuSci",
                    )
                    .getChart()
